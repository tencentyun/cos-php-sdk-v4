...
### 安装（直接下载源码集成）
直接从[github](https://github.com/tencentyun/cos-php-sdk)下载源码，然后在您的程序中加载cos-php-sdk/include.php就可以了。

### 修改配置
修改cos-php-sdk/qcloudcos/conf.php内的APPID、SECRET_ID、SECRET_KEY为您的配置。

### 示例程序
请参考sample.php

```php
// 包含cos-php-sdk/include.php文件
